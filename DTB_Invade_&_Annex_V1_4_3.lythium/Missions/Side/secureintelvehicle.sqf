...
#define OBJUNIT_TYPES "rhs_rva_crew_officer_armored"
...
_nospawning = ["respawn_west","FOB_Martian","FOB_Marathon","FOB_Guardian","Dirt_Track","Dirt_Last_Stand","USS_Freedom","currentAO"];   
