...
_infteams = ["rhs_group_rus_vdv_infantry_section_AA","rhs_group_rus_vdv_infantry_section_AT","rhs_group_rus_vdv_infantry_section_marksman","rhs_group_rus_vdv_infantry_fireteam","rhs_group_rus_vdv_infantry_squad","rhs_group_rus_vdv_infantry_squad_mg_sniper"];
};
...
//=====defining vehicles=========
_Randomvehicle = ["rhs_tigr_sts_3camo_vdv"];	
sleep 0.1;

//=====defining inf units=======
if (_faction =="rhs_faction_vdv") then{
_infunits = ["rhs_vdv_recon_arifleman","rhs_vdv_recon_efreitor","rhs_vdv_recon_rifleman_asval","rhs_vdv_recon_rifleman_lat","rhs_vdv_recon_sergeant","rhs_vdv_recon_marksman_vss","rhs_vdv_recon_medic","rhs_vdv_recon_rifleman_scout_akm"];
};
if (_faction =="IND_C_F") then{
